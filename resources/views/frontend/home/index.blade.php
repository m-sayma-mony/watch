            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <div class="header-img">
                        <img src="{{asset('/')}}assets/frontend/img/watch-header.png" alt="Product Image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="product-img">
                        <img src="{{asset('/')}}assets/frontend/img/watch-features.png" alt="Product Image">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="product-feature">
            ...
            <div class="row align-items-center">
                <div class="col-md-3">
                    <div class="product-single">
                        <div class="product-img">
                            <img src="{{asset('/')}}assets/frontend/img/product-1.png" alt="Product Image">
                        </div>
                        <div class="product-content">
                ...
                <div class="col-md-3">
                    <div class="product-single">
                        <div class="product-img">
                            <img src="{{asset('/')}}assets/frontend/img/product-2.png" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <h2>Sports Edition</h2>
                            <h3>$199</h3>
                ...
                <div class="col-md-3">
                    <div class="product-single">
                        <div class="product-img">
                            <img src="{{asset('/')}}assets/frontend/img/product-3.png" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <h2>Sports Edition</h2>
                            <h3>$249</h3>
                ...
                <div class="col-md-3">
                    <div class="product-single">
                        <div class="product-img">
                            <img src="{{asset('/')}}assets/frontend/img/product-4.png" alt="Product Image">
                        </div>
                        <div class="product-content">
                            <h2>Sports Edition</h2>
                            <h3>$299</h3>
            ...
            <div class="owl-carousel testimonials-carousel">
                <div class="testimonial-item">
                    <div class="testimonial-img">
                        <img src="{{asset('/')}}assets/frontend/img/testimonial-1.jpg" alt="">
                    </div>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-img">
                        <img src="{{asset('/')}}assets/frontend/img/testimonial-2.jpg" alt="">
                    </div>
                    <div class="testimonial-content">
                        <h3>Mollie White</h3>
                        <h4>Youtuber</h4>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-img">
                        <img src="{{asset('/')}}assets/frontend/img/testimonial-3.jpg" alt="">
                    </div>
                    <div class="testimonial-content">
                        <h3>Tom McKenzie</h3>
                        <h4>Videographer</h4>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-img">
                        <img src="{{asset('/')}}assets/frontend/img/testimonial-4.jpg" alt="">
                    </div>
                    <div class="testimonial-content">
                        <h3>Ruby Forster</h3>
                        <h4>Photographer</h4>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-img">
                        <img src="{{asset('/')}}assets/frontend/img/testimonial-5.jpg" alt="">
                    </div>
                    <div class="testimonial-content">
                        <h3>Leo Conway</h3>
